...
// discipline two.
//
// The same helper exists in internal/infra/postgres. Keeping a copy rather than
...
const globalSweepLockKey = 8_845_120_301 // arbitrary, must match internal/infra/postgres
