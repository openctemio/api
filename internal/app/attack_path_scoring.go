...
// AttackPathSummary holds aggregate attack path metrics for the tenant.
...
// AttackPathScoringResult is the full result returned by ComputeAttackPathScores.
type AttackPathScoringResult struct {
...
func (s *AttackSurfaceService) ComputeAttackPathScores(
	ctx context.Context,
	tenantID shared.ID,
	relRepo asset.RelationshipRepository,
) (*AttackPathScoringResult, error) {
	// Step 1 — load nodes
	...
	return &AttackPathScoringResult{
		Summary:   summary,
		TopAssets: scored,
	}, nil
}
