...
// git credentials. Kept local so the template package does not import the
...
func (s *Syncer) createFetcher(ctx context.Context, source *templatesource.TemplateSource) (fetchers.Fetcher, error) {
...
func (s *Syncer) createGitFetcher(ctx context.Context, source *templatesource.TemplateSource) (*fetchers.GitFetcher, error) {
...
func (s *Syncer) createS3Fetcher(ctx context.Context, source *templatesource.TemplateSource) (*fetchers.S3Fetcher, error) {
...
func (s *Syncer) createHTTPFetcher(ctx context.Context, source *templatesource.TemplateSource) (*fetchers.HTTPFetcher, error) {
...
func (s *Syncer) getCredential(ctx context.Context, tenantID, credentialID shared.ID) (any, error) {
	return s.secretStoreSvc.DecryptCredentialData(ctx, tenantID, credentialID.String())
}

func (s *Syncer) processTemplates(ctx context.Context, source *templatesource.TemplateSource, files map[string][]byte) (int, error) {
...
func (s *Syncer) getExtensionsForTemplateType(templateType scannertemplate.TemplateType) []string {
	switch templateType {
...
func (s *Syncer) getValidator(templateType scannertemplate.TemplateType) TemplateValidator {
	switch templateType {
	case scannertemplate.TemplateTypeNuclei:
...
func (s *Syncer) markSyncFailed(ctx context.Context, source *templatesource.TemplateSource, errMsg string) {
	source.LastSyncAt = ptr(time.Now())
